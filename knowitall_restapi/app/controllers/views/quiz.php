...
<main class="">
    ...
    <div id="answers-container" class="container d-flex flex-wrap justify-content-center">
        ...
        <button class="answer"><span class="round-font">Lorem ipsum dolor sit amet, consectetur adipiscing</span></button>
        <button class="answer"><span class="round-font">Lorem dolor sit amet, consectetur adipiscing</span></button>
    </div>
